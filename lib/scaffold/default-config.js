...
/**
 * Will return the path and default veriumcore-node configuration. It will search for the
 * configuration file in the "~/.veriumcore" directory, and if it doesn't exist, it will create one
...
function getDefaultConfig(options) {
  ...
  var defaultPath = path.resolve(process.env.HOME, './.veriumcore');
  var defaultConfigFile = path.resolve(defaultPath, './veriumcore-node.json');
