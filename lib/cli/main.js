...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `veriumcore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ veriumcore-node add wallet-service');
      console.log('    $ veriumcore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ veriumcore-node remove wallet-service');
      console.log('    $ veriumcore-node remove insight-api');
      console.log();
    });
